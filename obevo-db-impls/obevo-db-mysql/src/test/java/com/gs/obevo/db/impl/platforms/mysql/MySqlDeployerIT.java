...
public class MySqlDeployerIT {
    ...
    public void testDeploy() throws Exception {
        ...
        try {
            List<Map<String, Object>> results = jdbc.queryForList(conn, "select * from " + dbDeployerAppContext.getEnvironment().getPhysicalSchema("refschema1") + ".TABLE_A order by a_id");
