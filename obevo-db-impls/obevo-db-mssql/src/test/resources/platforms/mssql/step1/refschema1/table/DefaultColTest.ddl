//// CHANGE name=init
CREATE TABLE ${refschema1_subschemaSuffixed}DefaultColTest  (
...
GO
ALTER TABLE ${refschema1_subschemaSuffixed}DefaultColTest ADD CONSTRAINT PK_DefaultColTest PRIMARY KEY (id)
GO
