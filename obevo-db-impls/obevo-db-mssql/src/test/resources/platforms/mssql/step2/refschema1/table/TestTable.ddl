//// CHANGE name=init
CREATE TABLE ${refschema1_subschemaSuffixed}TestTable
(
...
//// CHANGE name=indexes
CREATE INDEX IND1 ON ${refschema1_subschemaSuffixed}TestTable(stringField)
GO
DROP INDEX ${refschema1_subschemaSuffixed}TestTable.IND1
GO
CREATE INDEX IND1 ON ${refschema1_subschemaSuffixed}TestTable(stringField)
GO

//// CHANGE name=modify
ALTER TABLE ${refschema1_subschemaSuffixed}TestTable ADD myNewCol2 INT NULL
GO

//// CHANGE name=rename excludeEnvs="unittest*"
sp_rename '${refschema1_subschemaSuffixed}TestTable.myNewCol2', 'myNewCol'
GO

//// CHANGE name=rename includeEnvs="unittest*"
ALTER TABLE ${refschema1_subschemaSuffixed}TestTable ALTER COLUMN myNewCol2 RENAME TO myNewCol
GO
